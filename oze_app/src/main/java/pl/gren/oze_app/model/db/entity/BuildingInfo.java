...
public class BuildingInfo {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getId(), that.getId()) && Objects.equals(getClient(), that.getClient()) && Objects.equals(getLocation(), that.getLocation()) && Objects.equals(getLocationTemperatureCelcius(), that.getLocationTemperatureCelcius()) && getBuildingType() == that.getBuildingType() && Objects.equals(getLengthMeters(), that.getLengthMeters()) && Objects.equals(getWidthMeters(), that.getWidthMeters()) && Objects.equals(getHeatedAreaSquareMeters(), that.getHeatedAreaSquareMeters()) && Objects.equals(getCeilingHeightMeters(), that.getCeilingHeightMeters()) && Objects.equals(getHeatingTemperatureCelcius(), that.getHeatingTemperatureCelcius()) && Objects.equals(getCoolingTemperatureCelcius(), that.getCoolingTemperatureCelcius()) && Objects.equals(getHasBasement(), that.getHasBasement()) && getWallType() == that.getWallType() && getWallInsulationType() == that.getWallInsulationType() && getRoofInsulationType() == that.getRoofInsulationType() && getFloorInsulationType() == that.getFloorInsulationType() && Objects.equals(getWallThicknessCm(), that.getWallThicknessCm()) && Objects.equals(getWallInsulationThicknessCm(), that.getWallInsulationThicknessCm()) && Objects.equals(getRoofInsulationThicknessCm(), that.getRoofInsulationThicknessCm()) && Objects.equals(getFloorInsulationThicknessCm(), that.getFloorInsulationThicknessCm()) && getWindowGlazingType() == that.getWindowGlazingType() && Objects.equals(getWindowCount(), that.getWindowCount()) && Objects.equals(getExteriorDoorCount(), that.getExteriorDoorCount()) && getVentilationType() == that.getVentilationType() && getFuelType() == that.getFuelType() && Objects.equals(getFuelUsageAmount(), that.getFuelUsageAmount()) && Objects.equals(getPeopleCount(), that.getPeopleCount()) && getWaterUsageType() == that.getWaterUsageType() && Objects.equals(getContract(), that.getContract());
    }
}
