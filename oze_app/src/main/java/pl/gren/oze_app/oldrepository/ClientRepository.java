...
@Repository
public interface ClientRepository extends JpaRepository<_Client, Long> {
    ...
    List<_Client> findClientsBySalesmanId(Long id);
    Optional<_Client> findClientById(Long id);
    ...
    _Client findClientByBuilding_Requirements_Id(@Param("buildingId") Long buildingId);
}